...
moving_cor_diss_xy_prec <- function(X, Y, w, block_x = 1024L, block_y = 1024L, precision = "double") {
    .Call('_resemble_moving_cor_diss_xy_prec', PACKAGE = 'resemble', X, Y, w, block_x, block_y, precision)
}

moving_cor_diss_self_f64 <- function(X, w, block_rows = 1024L) {
    .Call('_resemble_moving_cor_diss_self_f64', PACKAGE = 'resemble', X, w, block_rows)
}

moving_cor_diss_self_f32 <- function(X, w, block_rows = 1024L) {
    .Call('_resemble_moving_cor_diss_self_f32', PACKAGE = 'resemble', X, w, block_rows)
}
...
moving_cor_diss_self <- function(X, w, block_rows = 1024L, precision = "double") {
    .Call('_resemble_moving_cor_diss_self', PACKAGE = 'resemble', X, w, block_rows, precision)
}
