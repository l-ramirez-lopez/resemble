...
fastDist <- function(X, Y, method) {
    .Call('_resemble_fastDist', PACKAGE = 'resemble', X, Y, method)
}
...
fastDistVV <- function(X, cores) {
    .Call('_resemble_fastDistVV', PACKAGE = 'resemble', X, cores)
}
...
movcorDist <- function(X, Y, w) {
    .Call('_resemble_movcorDist', PACKAGE = 'resemble', X, Y, w)
}
...
#' @useDynLib resemble
wcolSds <- function(X) {
    .Call('_resemble_wcolSds', PACKAGE = 'resemble', X)
}
...
#' @useDynLib resemble
colSds <- function(X) {
    .Call('_resemble_colSds', PACKAGE = 'resemble', X)
}
...
predopls <- function(bo, b, ncomp, newdata, scale, Xscale) {
    .Call('_resemble_predopls', PACKAGE = 'resemble', bo, b, ncomp, newdata, scale, Xscale)
}
...
projectpls <- function(projectionm, ncomp, newdata, scale, Xcenter, Xscale) {
    .Call('_resemble_projectpls', PACKAGE = 'resemble', projectionm, ncomp, newdata, scale, Xcenter, Xscale)
}
...
waplswCpp <- function(projectionm, xloadings, coefficients, newX, minF, maxF, scale, Xcenter, Xscale) {
    .Call('_resemble_waplswCpp', PACKAGE = 'resemble', projectionm, xloadings, coefficients, newX, minF, maxF, scale, Xcenter, Xscale)
}
...
pplscv_cpp <- function(X, Y, scale, method, mindices, pindices, minF, ncomp, newX, maxiter, tol, waplsgrid) {
    .Call('_resemble_pplscv_cpp', PACKAGE = 'resemble', X, Y, scale, method, mindices, pindices, minF, ncomp, newX, maxiter, tol, waplsgrid)
}
...
gprdp <- function(X, Y, noisev = 0.001, scale = TRUE) {
    .Call('_resemble_gprdp', PACKAGE = 'resemble', X, Y, noisev, scale)
}
...
predgprdp <- function(Xz, alpha, newdata, scale, Xcenter, Xscale, Ycenter, Yscale) {
    .Call('_resemble_predgprdp', PACKAGE = 'resemble', Xz, alpha, newdata, scale, Xcenter, Xscale, Ycenter, Yscale)
}
...
pgpcv_cpp <- function(X, Y, mindices, pindices, noisev = 0.001, scale = TRUE) {
    .Call('_resemble_pgpcv_cpp', PACKAGE = 'resemble', X, Y, mindices, pindices, noisev, scale)
}
...
which_min <- function(X, cores) {
    .Call('_resemble_which_min', PACKAGE = 'resemble', X, cores)
}
...
which_minV <- function(X, cores) {
    .Call('_resemble_which_minV', PACKAGE = 'resemble', X, cores)
}
