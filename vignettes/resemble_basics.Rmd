...
chosen) of the preprocessed spectra in the training set:

```{r}
# principal component (pc) analysis with the default 
# method (singular value decomposition) for 5 components
five_pcs_tr <- ortho_projection(Xr = training$spc_p,
