...
find few new variables that capture as much of the original data variance 
while in the latter the objective is to find few new variables that maximize 
their variance with respect to a set of one or more external variables (e.g. 
response variables or side information variables). 

In both cases, the 


Both methods assume that the meaningful structure the data intrinsically lies on 
a lower dimensional space



new variables 
are projected to capture the variance of the original variables in a 

maximize the variance 
of the original variables

projects the new variables in 
the direction of their maximal variation 


while the latter projects the new 
