...
* [Sanderman et al., 2022](https://acsess.onlinelibrary.wiley.com/doi/full/10.1002/saj2.20513) used `resemble` to study the transferability of large IR spectral databases across instruments. 

* [Dangal et al., 2022](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2021MS002622) used 
`resemble` in an study aiming at improving Soil Carbon Estimates.
